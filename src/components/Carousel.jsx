            ...
            <div className="absolute inset-0 bg-black/30 flex flex-col justify-center px-4 sm:px-10 md:px-20
             text-white pt-16 sm:pt-0">
              <div className="animate__animated animate__fadeInUp ml-4 sm:ml-10 md:ml-20">
                <p className="text-xs sm:text-lg mb-2 sm:mb-3 max-w-xl text-light-gray font-lato">
                ...
                <p className="text-sm sm:text-base md:text-xl mb-2 sm:mb-3 max-w-xl text-light-gray font-lato">
                  Najbolje frizerske usluge u gradu</p>
                <p className="text-sm sm:text-sm md:text-lg mb-4 sm:mb-8 max-w-xl text-light-gray font-lato">
        ...
        <SwiperSlide>
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-black/30 flex flex-col justify-center px-4 sm:px-10 md:px-20
             text-white pt-16 sm:pt-0">
              <div className="animate__animated animate__fadeInUp ml-4 sm:ml-10 md:ml-20">
                <p className="text-xs sm:text-sm mb-2 sm:mb-3 max-w-xl font-lato text-light-gray">
        ...
        <SwiperSlide>
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-black/30 flex flex-col justify-center px-4 sm:px-10 md:px-20
             text-white pt-16 sm:pt-0">
              <div className="animate__animated animate__fadeInUp ml-4 sm:ml-10 md:ml-20">
                <p className="text-xs sm:text-sm mb-2 sm:mb-3 max-w-xl font-lato text-light-gray">Najbolje iskustvo</p>
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-6 text-third
