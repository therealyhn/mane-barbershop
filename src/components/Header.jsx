    ...
    return (
        <div className="relative w-full h-[80vh] bg-prime-dark">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
                <p className="text-lg md:text-xl animate__animated animate__fadeInDown text-third text-center w-full mb-2 font-lato">
                    {subtitle}
                </p>
                <h1 className="text-4xl md:text-5xl font-bold mb-4 animate__animated animate__fadeInUp text-white text-center w-full font-prata">
                    {title}
                </h1>
